...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            )  # basically it's X_train
            target_feature_train_df = train_df[
                target_column_name
            ]  # basically it's y_train

            input_feature_test_df = test_df.drop(
                columns=[target_column_name], axis=1
            )  # basically it's X_test
            target_feature_test_df = test_df[
                target_column_name
            ]  # basically it's y_test

            logging.info("Applying preprocessing object on train set and test set")
